...
| Platform | Download |
|----------|----------|
| Linux (AppImage) | [cygnus-md-0.2.5-linux-x86_64.AppImage](https://github.com/rizkyandriawan/cygnus-md/releases/download/v0.2.5/cygnus-md-0.2.5-linux-x86_64.AppImage) |
| Linux (deb) | [cygnus-md-0.2.5-linux-amd64.deb](https://github.com/rizkyandriawan/cygnus-md/releases/download/v0.2.5/cygnus-md-0.2.5-linux-amd64.deb) |
| Linux (rpm) | [cygnus-md-0.2.5-linux-x86_64.rpm](https://github.com/rizkyandriawan/cygnus-md/releases/download/v0.2.5/cygnus-md-0.2.5-linux-x86_64.rpm) |
| Windows (MSI) | [cygnus-md-0.2.5-win-x64.msi](https://github.com/rizkyandriawan/cygnus-md/releases/download/v0.2.5/cygnus-md-0.2.5-win-x64.msi) |
| Windows (Portable) | [cygnus-md-0.2.5-win-x64.exe](https://github.com/rizkyandriawan/cygnus-md/releases/download/v0.2.5/cygnus-md-0.2.5-win-x64.exe) |

## Features

- **Paginated A4 View** - Renders markdown as paginated A4 documents
- **Scroll View Mode** - Toggle between paginated and continuous scroll view
- **EPUB Support** - Read EPUB books with the same beautiful rendering
...
- **Export Options** - Export to PDF, DOCX, or HTML
